        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    <h5 class="card-title mb-0">Add New Labour Type</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('labourtypes.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01" class="form-control @error('standard_rate') is-invalid @enderror" 
                                           id="standard_rate" name="standard_rate" value="{{ old('standard_rate', 0) }}" required>
                                    @error('standard_rate')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('unit') is-invalid @enderror" id="unit" name="unit" required>
                                        ...
                                        <option value="week" {{ old('unit') == 'week' ? 'selected' : '' }}>Week</option>
                        ...
                        <div class="d-flex justify-content-between">
                            ...
                            <button type="submit" class="btn btn-primary">
                                <i class="ri-save-line align-middle me-1"></i> Save Labour Type
                            </button>
                        </div>
                    </form>
                </div>
